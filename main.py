#Building a basic currency exchange API

#Flask framework module is always lowercase
...
#webscrape script to get the currency rates
...
@app.route('/')
def home():
  return '<h1>Abbas Currency Rate API</h1> <p>Example URL: /api/v1/usd-eur</p>'
